...
#video = cv2.VideoCapture('video/upds.mp4')
video = cv2.VideoCapture('video/race.mp4')
...
while True:
    ...
    if ok == True:
        ...
        #print(x, y, w, h)
        cv2.rectangle(frame, (x, y), (x + w, y + h), colors, 5)
    else:
        cv2.putText(frame, 'Falla de seguimiento!', (100,80), cv2.FONT_HERSHEY_SIMPLEX, .75, (0,0,255))
